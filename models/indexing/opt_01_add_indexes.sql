...
CREATE INDEX IF NOT EXISTS idx_transactions_date_client_id ON transactions_data (date, client_id);

-- INDEX IF NOT EXISTS 6: Fraud Transaction ID
CREATE INDEX IF NOT EXISTS idx_fraud_id ON train_fraud_labels (id);