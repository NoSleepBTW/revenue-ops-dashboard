...
ALTER COLUMN retirement_age TYPE SMALLINT USING CAST(retirement_age AS SMALLINT),
...
ALTER COLUMN per_capita_income TYPE INTEGER USING CAST(per_capita_income AS INTEGER),
...
ALTER COLUMN num_credit_cards TYPE SMALLINT USING CAST(num_credit_cards AS SMALLINT),
ADD PRIMARY KEY (id);